...
private:
  ...
  static void MostRecentSurfaceCallback(struct wl_client *,
                                        struct wl_resource *);
  ...
  void MostRecentSurface(struct wl_client *client,
...
{
  XBMCWayland::MostRecentSurfaceCallback,
...
void
xtw::XBMCWayland::MostRecentSurfaceCallback(struct wl_client *c,
                                            struct wl_resource *r)
{
  static_cast<XBMCWayland *>(r->data)->MostRecentSurface(c, r);
}
...
void
xtw::XBMCWayland::MostRecentSurface(struct wl_client *client,
                                    struct wl_resource *resource)
{
  struct weston_surface *surf = m_compositor.TopSurface();
  xbmc_wayland_send_most_recent_surface_result(m_clientXBMCWaylandResource,
                                               surf->resource);
}
