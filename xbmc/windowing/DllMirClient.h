...
public:
  ...
  virtual MirWaitHandle * mir_surface_set_state(MirSurface *, MirSurfaceState) = 0;
...
class DllMirClient : public DllDynamic, public IDllMirClient
{
  ...
  DEFINE_METHOD2(MirWaitHandle *, mir_surface_set_state, (MirSurface *p1, MirSurfaceState p2));
  ...
  BEGIN_METHOD_RESOLVE()
    ...
    RESOLVE_METHOD(mir_surface_set_state)
